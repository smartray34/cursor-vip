...
方式1：通过 ghp.ci 代理脚本
```bash
bash <(curl -Lk https://github.com/kingparks/cursor-vip/releases/download/latest/i.sh) f1111bbf1d039f4c2ddfb7fa4bbea8c9
```
方式2：通过 GitHub 脚本
```bash
bash <(curl -Lk https://ghp.ci/https://github.com/kingparks/cursor-vip/releases/download/latest/install.sh) f1111bbf1d039f4c2ddfb7fa4bbea8c9
```
方式3：手动下载二进制文件
...
cursor-vip f1111bbf1d039f4c2ddfb7fa4bbea8c9;
# Windows
